        ...
        <div className='text-center'>
          ...
          <p>
              {props.info.disponibility  && props.info.disponibility === "IN STOCK" ? (
                <span style={{ color: "green", fontSize:"13.5px" }}>{props.info.disponibility}</span>
              ) : (
                <span style={{ color: "red", fontSize:"13.5px"  }}>{props.info.disponibility}</span>
              )}
          </p>
          <p>
            <button className='btnp'>
              <span className='textp'>Ajouter au panier</span>
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5 iconp">
