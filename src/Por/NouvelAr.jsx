...
export default function NouvelAr(props) {
    const condipromo = props.condipromo;
    const product2 = props.product2;

    return product2 ? (
        <Link to={`/product2/${props.info.id}`}>
                ...
                <div className="flex flex-col justify-between card mr-0 w-24 p-2">
                    ...
                    <div className='text-center'>
                        ...
                        <p className="text-red-800">
                            <span style={{ fontWeight: "750", fontSize: "15px" }}>{props.info.new_price}</span>
                        </p>
                        <p>
                            <span style={{ color: "#e74c3c", fontWeight: "450", textDecoration: "line-through", fontSize: "12px" }}>{props.info.old_price}</span>
                        </p>
                        <p>
                        ...
                        <p>
                            <button className='btnp'>
                                <span className='textp'>Lire la suite</span>
