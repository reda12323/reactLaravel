        ...
        <div className="min-h-screen ">
            ...
            <nav className="flex items-start ml-20">
                <div id="Fbarp" className="flex ">
                    ...
                    <div className="P2B"><Link to="/boutique">Boutique</Link></div>
                    <div id="P1B"><Link to="/promotion">Promotion</Link></div>
                    <div id="P1B"><Link to="/props">À Propos</Link></div>
                    <div id="P1B"><Link to="/contacte">Contacte</Link></div>
                </div>
